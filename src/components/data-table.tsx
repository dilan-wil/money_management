...
export function DataTable<TData, TValue>({
  ...
  // Determine the filter field dynamically based on the type
  const filterField = type === "income" ? "source" : "category"
  ...
  return (
    <div className="">
      <div className="flex items-center py-4">
        <Input
          placeholder={`Filter by ${type === "income" ? "source" : "category"}...`}
